<ul class="nav nav-tabs nav-justified mt-3 fw-bold">
    ...
    @guest
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('about') }}" title="About-us"><span class="fab fa-accessible-icon"
                    style="font-size: 1.5rem"></span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('contact') }}" title="Contact"><span class="fas fa-mail-bulk"
                    style="font-size: 1.5rem"></span></a>
        </li>
    @endguest
    ...
    @auth
        <li class="nav-item">
            <a class="nav-link" href="{{ route('home') }}" title="home"><span class="fas fa-home"
                    style="font-size: 1.5rem"></span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('articles') }}" title="Articles"><span class="fas fa-blog"
                    style="font-size: 1.5rem"></span></a>
        </li>

        @can('create', 'App\Models\Article')
            <li class="nav-item">
                <a class="nav-link" href="{{ route('create') }}" title="Create article"><span class="fas fa-plus-square"
                        style="font-size: 1.5rem"></span></a>
            </li>
        @endcan
